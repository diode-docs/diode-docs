...
All data for Diode Collab is encrypted at rest. When you implement a PIN, your PIN is used as an additional encryption key. Your data cannot be retrieved through the app or from the host system without the PIN code.
